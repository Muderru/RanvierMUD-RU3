...
module.exports = {
  ...
  run: state => function (args, player, target) {
    ...
    Broadcast.sayAt(player, `<bold><blue>Воздух между ваших рук замерз, принимая форму сосульки, которая поражает вашего врага!</blue></bold>`);
  ...
  info: (player) => {
    return `Создает ледяную сосульку, наносящую урон зависящий от урона вашего оружия, интеллекта, вашего бонусного урона холодом, уровня владения умением и сопротивляемости огню цели.`;
  }
};
