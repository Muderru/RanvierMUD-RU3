...
module.exports = {
  listeners: {
    updateTick: (state) => function () {
      ...
      const bot = Array.from(this.room.npcs).find((npc) => npc.entityReference === 'pets:balance_bot2');
      if (bot) {
    ...
    killed: (state) => function (killer) {
      ...
      state.ChannelManager.get('say').send(state, this, `Убит, у бота 2 осталось ${ratio}% жизни.`);
    },
  },
};
