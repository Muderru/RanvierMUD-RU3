...
module.exports = {
  ...
  command: (state) => (args, p) => {
    ...
    if (args === 'сила' || args === 'силу') {
      ...
      const strength = p.attributes.get('strength');
    ...
    if (args === 'ловкость') {
      ...
      const agility = p.attributes.get('agility');
    ...
    if (args === 'интеллект') {
      ...
      const intellect = p.attributes.get('intellect');
    ...
    if (args === 'выносливость') {
      ...
      const stamina = p.attributes.get('stamina');
